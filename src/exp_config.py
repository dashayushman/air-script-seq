...
class ExpConfig:
    ...
    DATA_PATH = '/mnt/train_shuffled_words.txt'  # path containing data file
    # names and labels. Format:
    MODEL_DIR = 'train'  # the directory for saving and loading model
    # parameters (structure is not stored)
    LOG_PATH = 'log.txt'
    OUTPUT_DIR = 'results'  # output directory
    STEPS_PER_CHECKPOINT = 500  # checkpointing (print perplexity,
    # save model) per how many steps

    # Optimization
    NUM_EPOCH = 1000
    BATCH_SIZE = 64
    INITIAL_LEARNING_RATE = 1.0  # initial learning rate, note the we use
